...
** https://redhat.invisionapp.com/share/2RCOE72PE[Concept A: Single Cluster / Element Manager Concept for Multi-Level Drill Down (leveraging existing Multiple-Cluster Management designs and implementations)]
