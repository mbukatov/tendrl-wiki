...
* https://github.com/Tendrl/documentation/wiki/Tendrl-UI-Designs-for-Gluster-Only-Monitoring-Release-(Tendrl-Release-1.6.3-and-earlier)[List of UI Design Artifacts for Gluster-Only Monitoring for Tendrl 1.6.3]
