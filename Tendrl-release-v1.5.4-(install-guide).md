...
- The server hosting tendrl-api/central_store should have minimum 32 GB of memory and 12 VCPUs (or equivalent)(due to alerts, logs being stored on this node) available to be used by the Tendrl server
